...
local Window = OrionLib:MakeWindow({Name = "kam hub", HidePremium = false, IntroText = "kam hub", SaveConfig = true, ConfigFolder = "Specialized"})
...
OrionLib:MakeNotification({
	Name = "kam hub",
	Content = "kam hub Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
